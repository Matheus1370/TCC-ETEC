...
const char* ssid = "jailson";
const char* password = "diascerqueira2019";
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
const char *host = "http://192.168.1.121";
//----------------------------------------
...
// put your main code here, to run repeatedly:
  ...
  GetAddress = "/site/phpcode/GetData.php"; 
  ...
  SendAddress = "/site/phpcode/getLEDStatFromNodeMCU.php";
  ...
  digitalWrite(ON_Board_LED, LOW);
    ...
    http.begin("http://192.168.1.121/Site/phpcode/getUID.php");  //Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded"); //Specify content-type header
